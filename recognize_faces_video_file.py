...
while True:
	...
	for ((top, right, bottom, left), name) in zip(boxes, names):
		...
		cv2.putText(frame, name, (left, y), cv2.FONT_HERSHEY_SIMPLEX,
			0.75, (0, 255, 0), 2)
		count+=1
		cv2.imwrite('D:\\PIS\\ESP8266 Node Code\\frame'+str(count)+'.jpg', frame)
...
if not (names==[] or names==["Unknown"]):
	send_mail_gmail('bogus993@gmail.com','kartikgaming',toaddrs_list,str(names),'bogus993@gmail.com','Student Data who went out',files)
